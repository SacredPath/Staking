Write-Host "Setting up Vercel environment variables for MAMBO Staking..." -ForegroundColor Green
...
Write-Host "Please redeploy your project after setting these variables." -ForegroundColor Yellow
